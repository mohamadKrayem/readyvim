return {
	...
	config = function()
		...
		local servers = {
			-- JavaScript / TypeScript / React (Node included)
			ts_ls = {},
			-- Emmet for fast HTML/JSX/CSS expansion
			emmet_language_server = {
				filetypes = { "html", "css", "scss", "javascriptreact", "typescriptreact", "vue", "svelte" },
			},
			-- Python: ruff for lint/format, basedpyright for types & completion.
			-- basedpyright is much stronger than pylsp for typed AI code
			-- (LangGraph / LangChain generics, go-to-def into library source).
			ruff = {},
			basedpyright = {
				settings = {
					basedpyright = {
						analysis = {
							-- "standard" ~ pyright "basic": useful types without drowning
							-- you in warnings from libraries with partial stubs.
